...
INSERT INTO PLANE (pLNUM, pLCOM, pLCOMCODE, pLNAME, pLSEAT)
    VALUES (PL_SEQ.NEXTVAL, '진에어', 'LJ', 'B737', 140);
INSERT INTO PLANE (pLNUM, pLCOM, pLCOMCODE, pLNAME, pLSEAT)
    VALUES (PL_SEQ.NEXTVAL, '에어서울', 'RS', 'A320', 201);

INSERT INTO AIRLINE_TICKET (atID, aCTNAME, dCTNAME, pLNUM, atPRICE, atATIME, atDTIME, atPHOTO)
    VALUES (AT_SEQ.NEXTVAL, '인천', '로마', 300, 1532400, '2023-04-20 10:00', '2023-04-20 23:30', 'NOIMAGE.JPG');
INSERT INTO AIRLINE_TICKET (atID, aCTNAME, dCTNAME, pLNUM, atPRICE, atATIME, atDTIME, atPHOTO)
    VALUES (AT_SEQ.NEXTVAL, '김포', '방콕', 301, 326200, '2023-05-12 16:00', '2023-05-13 01:30', 'NOIMAGE.JPG');
INSERT INTO AIRLINE_TICKET (atID, aCTNAME, dCTNAME, pLNUM, atPRICE, atATIME, atDTIME, atPHOTO)
    VALUES (AT_SEQ.NEXTVAL, '인천', '세부', 302, 469800, '2023-05-21 10:00', '2023-05-21 18:30', 'NOIMAGE.JPG');
INSERT INTO AIRLINE_TICKET (atID, aCTNAME, dCTNAME, pLNUM, atPRICE, atATIME, atDTIME, atPHOTO)
    VALUES (AT_SEQ.NEXTVAL, '인천', '제네바', 303, 1149800, '2023-04-30 23:00', '2023-05-01 11:30', 'NOIMAGE.JPG');
INSERT INTO AIRLINE_TICKET (atID, aCTNAME, dCTNAME, pLNUM, atPRICE, atATIME, atDTIME, atPHOTO)
    VALUES (AT_SEQ.NEXTVAL, '인천', '오사카', 304, 321900, '2023-05-11 15:00', '2023-05-12 18:30', 'NOIMAGE.JPG');
INSERT INTO AIRLINE_TICKET (atID, aCTNAME, dCTNAME, pLNUM, atPRICE, atATIME, atDTIME, atPHOTO)
    VALUES (AT_SEQ.NEXTVAL, '인천', '후쿠오카', 305, 209800, '2023-05-20 11:00', '2023-05-20 15:00', 'NOIMAGE.JPG');
